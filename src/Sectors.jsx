...
import { 
  ...
  Target, TrendingUp, Menu, X, // Add Rocket and Users
} from 'lucide-react';
            ...
            >
              ...
              <div className="absolute inset-0 p-8 flex flex-col justify-end">
                ...
                <div>
                  ...
                  <h3 className="text-2xl uppercase text-white mb-3 leading-tight">{sector.title}</h3>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="flex flex-col md:flex-row items-end justify-between mb-16 gap-6">
            <div className="max-w-2xl">
              <h2 className="text-4xl uppercase md:text-5xl text-white mb-4">Why These <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-blue to-brand-purple italic">Sectors?</span></h2>
